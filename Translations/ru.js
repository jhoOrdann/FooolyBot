const language = {
    ...
    msg32: "Как дела? Заранее благодарим вас за использование Foooly :D \nУ вас есть вопросы по командам? [нажмите здесь](https://foooly.vercel.app) и разрешите свои сомнения :) \nХотите узнать больше о Premium? [Нажмите здесь](https://foooly.vercel.app/premium) \nСм. наши команды ниже.",
    msg33: "Бот-Команды",
